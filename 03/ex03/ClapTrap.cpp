...
ClapTrap::ClapTrap()
	...
	_attackDamage(0)
{
	std::cout << "ClapTrap the Parent \"Default\" spawned!" << "\n";
}
...
ClapTrap::ClapTrap(const ClapTrap &src)
{
	...
	std::cout << "Copy constructor called. ClapTrap the Parent " << _name << " spawned!" << "\n";
}
...
ClapTrap &ClapTrap::operator=(const ClapTrap &src)
{
	...
	std::cout << "Copy assignment operator of the Parent called. I am now " << _name << "\n";
	return (*this);
}
...
ClapTrap::~ClapTrap()
{
	std::cout << "ClapTrap the Parent " << _name << " destroyed!" << "\n";
}
// -----------------------
...
ClapTrap::ClapTrap(std::string name)
	...
	_attackDamage(0)
{
	std::cout << "ClapTrap the Parent \"" << _name << "\" spawned!" << "\n";
}
